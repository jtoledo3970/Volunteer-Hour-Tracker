...
open class Floaty: UIView {
	...
	*/
    ...
    /**
        Button color.
    */
    @IBInspectable open var buttonColor: UIColor = UIColor(red:0, green:0.479, blue:0.999, alpha:0.6)
        // Default UIColor(red: 73/255.0, green: 151/255.0, blue: 241/255.0, alpha: 1)
    ...
    */
    @IBInspectable open var plusColor: UIColor = UIColor.white
    /**
